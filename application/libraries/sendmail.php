...
class CI_Email
{
	...
	//var $smtp_host = "192.168.3.62"; // SMTP Server.  Example: mail.earthlink.net
	//var $smtp_user = "noreply@admarket.admicro.vn"; // SMTP Username
	//var $smtp_pass = "FaKUFadyitK493IGd5X"; // SMTP Password
	
	var $smtp_host = "mail.chotam.info"; // SMTP Server.  Example: mail.earthlink.net
	var $smtp_user = "thamhut@chotam.info"; // SMTP Username
	var $smtp_pass = "lytieulong"; // SMTP Password

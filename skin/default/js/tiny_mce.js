...
tinymce.util.Quirks = function (a) {
    ...
    function v() {
        var O, N, ae, M, Z, ac, aa, ad, P, Q, ab, X, W, Y = document,
            U = a.getDoc();
...
tinymce.html.Styles = function (d, f) {
    ...
    return {
        ...
        parse: function (s) {
            var z = {}, q, n, x, r, v = d.url_converter,
